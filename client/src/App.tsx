...
import { Coffee, ArrowRight, QrCode, Sparkles, CheckCircle2, Monitor } from "lucide-react";
...
function App() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-slate-950 text-slate-100 px-4 sm:px-6 select-none overflow-hidden py-12">
      ...
      <div className="relative z-10 w-full max-w-2xl text-center space-y-8 p-6 sm:p-10 rounded-3xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl shadow-2xl">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs font-bold">
          ...
          Smart QR Ordering & Real-Time Cafe Display
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm sm:text-base text-slate-400 max-w-lg mx-auto leading-relaxed">
            Smart Table QR Ordering, real-time customer status tracking, live Cafe TV Display, Kitchen Display System (KDS), and full POS register.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Button
            ...
            className="w-full sm:w-auto h-12 px-7 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-black text-sm shadow-xl shadow-amber-500/25 flex items-center justify-center gap-2"
          >
            Launch Staff POS
          ...
          <Button
            ...
            className="w-full sm:w-auto h-12 px-5 rounded-xl bg-slate-800/80 border-slate-700 hover:bg-slate-700 text-slate-200 font-bold text-sm flex items-center justify-center gap-2"
          >
