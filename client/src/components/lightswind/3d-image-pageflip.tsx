...
// next-themes not needed in Vite — replaced with a no-op
// const useTheme = () => ({ theme: "light", resolvedTheme: "light" });
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {showSpineBinding && (
                        <div
                            className="absolute top-0 bottom-0 left-[-4px] w-[8px] rounded-l-sm shadow-2xl z-30 pointer-events-none"
                            style={{
                                background: "linear-gradient(to right, rgba(42,24,14,0.92) 0%, rgba(92,55,28,0.70) 50%, rgba(42,24,14,0.45) 100%)",
